...
import (
	...
	"github.com/tiennv147/grpc-gateway-example/pkg/ui/data/swagger"
...
func serve() {
	...
	pb.RegisterCrudServiceServer(grpcServer, newServer())
	...
	err := pb.RegisterCrudServiceHandlerFromEndpoint(ctx, gwmux, demoAddr, dopts)
	if err != nil {
		fmt.Printf("serve: %v\n", err)
		return
	}
